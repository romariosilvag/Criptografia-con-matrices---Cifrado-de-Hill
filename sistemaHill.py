...
| |___| |  _| | | (_| | (_| | (_) | (_| |  __/  _  | | | |
 \____|_|_| |_|  \__,_|\__,_|\___/ \__,_|\___|_| |_|_|_|_|
    ...
    print("El cifrado Hill fue propuesto por Lester S. Hill en 1929 y es un criptosistema que se basa en emplear una matriz como clave para cifrar un texto en claro y su inversa para descifrar el criptograma correspondiente.\n")
